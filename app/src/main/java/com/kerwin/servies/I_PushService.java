...
/**
 * Created by Kerwin on 2017/3/2.
 */

public class I_PushService extends UmengMessageService {
    private static final String TAG = "I_PushService";
